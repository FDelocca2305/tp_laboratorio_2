...
namespace BaseDeDatos
{
    public class ProductosDAO
    {
        ...
        /// <summary>
        /// Listo el ultimo producto de la tabla productos
        /// </summary>
        /// <returns></returns>
        public Producto ListarUltimoProducto()
        {
            //DataTable tabla = new DataTable();
            command.Connection = conexion.AbrirConexion();

            command.CommandText = "select TOP 1 IDPROD AS ID, CATEGORIAS.CATEGORIA,MARCAS.MARCA,DESCRIPCION,PRECIO from PRODUCTOS INNER JOIN CATEGORIAS ON PRODUCTOS.IDCATEGORIA = CATEGORIAS.IDCATEG INNER JOIN MARCAS ON PRODUCTOS.IDMARCA = MARCAS.IDMARCA ORDER BY IDPROD DESC";
            command.CommandType = CommandType.Text;
        ...
        /// <summary>
        /// Edito un producto pasandole la id y  el objeto creado anteriormente con sus datos nuevos
        /// </summary>
