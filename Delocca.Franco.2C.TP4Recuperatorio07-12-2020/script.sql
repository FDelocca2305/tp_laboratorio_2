-----------------------------------CREAR BASE DE DATOS-------------------------------
CREATE DATABASE FrancoDeloccaTP4Recuperatorio
GO
USE FrancoDeloccaTP4Recuperatorio
GO
...
CREATE TABLE VENTAS(
    ...
    --RELACIONES
    CONSTRAINT RELACION_A_PRODUCTOS FOREIGN KEY (IDPRODUCTO) REFERENCES PRODUCTOS (IDPROD)
)
